...
public class TwoToOneFragment extends Fragment implements ICsFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        LinearLayout linearLayout = (LinearLayout) inflater.inflate(R.layout.fragment_two_to_one, container, false);
                    ...
                    AjaxManager.ajax("/loadCountProductInfo", param, new AjaxCallback<JSONObject>() {
                        ...
                        public void callback(String url, JSONObject json, AjaxStatus status) {
                            ...
                            try {
                                ...
                                productService.loadProduct(productService.getCsType(), 2, productService.getSearchTxt(), totalItemCount, 10, new ProductLoadCallback() {
                                    @Override
